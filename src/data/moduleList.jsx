...
export const modulesConfig = [
  ...
  { id: 'tours', category: 'Satış & Pazarlama', name: 'Tur & Acente', icon: <Compass />, count: 3, color: '#f59e0b', keywords: ['tur', 'acente', 'sedna', 'gezi', 'safari', 'transfer'], component: lazy(() => import('../components/modules/TourManagement')) },
